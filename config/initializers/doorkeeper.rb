Doorkeeper.configure do
  ...
  resource_owner_from_credentials do |_routes|
   ...
   #User.authenticate(params[:name], '')
    a = User.authenticate(params[:name])
    Doorkeeper::AccessToken.where(resource_owner_id: a.id).delete_all if a
    a
  end
  ...
  # Reuse access owner token for the same resource within an application (disabled by default).
  #
